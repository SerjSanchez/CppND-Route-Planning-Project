...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
    ...
    for(RouteModel::Node *neighbor : current_node->neighbors) {
        ...
        neighbor->g_value = current_node->g_value + neighbor->h_value; //TODO check
...
RouteModel::Node *RoutePlanner::NextNode() {
    ...
    sort(open_list.begin(), open_list.end(), compareNodesCost);

    // Retrieve lowest sum node
    RouteModel::Node* lowestCostNode = open_list.back();

    //Remove lowest sum node from the list
    open_list.pop_back();

    //Return lowest sum node
